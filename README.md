...
### 📝 **Content Management**
- Rich content editor with HTML/Markdown support
- Advanced SEO optimization tools
- Content scheduling and publishing
- Media management with ImageKit integration
...
- Practice problems and cheatsheets
...
|----------|------------|---------|---------|
| **Framework** | Next.js | 14.2.18 | React framework with SSR/SSG |
| **Language** | TypeScript | 5.0 | Type-safe JavaScript |
| **Styling** | Tailwind CSS | 3.4.1 | Utility-first CSS framework |
| **Database** | MongoDB | 4.4+ | NoSQL database |
| **ORM** | Prisma | 6.1.0 | Database toolkit and ORM |
| **Authentication** | NextAuth.js | 4.24.11 | Authentication for Next.js |
| **Animations** | Framer Motion | 11.15.0 | Animation library |
| **UI Components** | Headless UI | 2.2.0 | Unstyled accessible components |
...
| **Content** | MDX Remote | 5.0.0 | MDX content rendering |
| **Email** | Nodemailer | 6.10.1 | Email functionality |
...
3. **Set up environment variables**
   ...
   # Optional: Demo credentials (UI only)
   ...
   # Optional: CMS URL for redirects
...
- Access cheatsheets and reference guides
...
│   ├── import-study-materials.js # Study materials import
│   └── setup-study-materials.js # Study materials setup
├── 📁 src/
...
│   │   │   ├── 📁 study/       # Study materials API
│   │   │   └── 📁 user/        # User management API
│   │   ├── 📁 auth/            # Authentication pages
│   │   ├── 📁 blog/            # Blog frontend pages
│   │   ├── 📁 dashboard/       # Admin dashboard
│   │   ├── 📁 study/           # Study materials pages
│   │   └── globals.css         # Global styles
│   ├── 📁 components/          # React components
│   │   ├── 📁 BlogList/        # Blog listing components
│   │   ├── 📁 DashboardTabs/   # Dashboard tab components
...
├── 📁 Study material/          # Study materials content
...
| `NEXT_PUBLIC_DEMO_EMAIL` | Demo user email | No | - |
| `NEXT_PUBLIC_DEMO_PASSWORD` | Demo user password | No | - |
| `IMAGEKIT_URL` | ImageKit CDN URL | No | - |
| `NEXT_PUBLIC_API_BASE_URL` | API base URL | No | Same origin |
| `NEXT_PUBLIC_CMS_URL` | CMS URL for redirects | No | - |
...
- **Reaction**: User reactions (likes, etc.)
- **Rating**: Content ratings
- **Bookmark**: User bookmarks
- **StudyProgress**: Learning progress tracking
- **StudyPlan**: Learning plans and goals
